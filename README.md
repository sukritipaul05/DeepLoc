...
###### Any changes to the model architecture in this repository are attributed to NonExomics (&copy;2021,NonExomics). Contact @sukritipaul05 while selecting your AWS EC2 instance and if you encounter any other issues.
